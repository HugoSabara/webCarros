...
const schema = z.object({
  ...
  email: z.string().email("Insira um e-mail válido.").nonempty("Campo é obrigatório."),
  password: z.string().min(6, "A senha deve ter pelo menos 6 caracteres.").nonempty("Campo de senha é obrigatório.")
